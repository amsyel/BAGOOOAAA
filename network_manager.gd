...
func start_game(selected_difficulty):
	print("Game starting with difficulty (received):", selected_difficulty)
	print("Game starting with difficulty (stored):", selected_difficulty)
	
	if not selected_difficulty or selected_difficulty.strip_edges() == "":
		print("⚠️ Error: selected_difficulty is empty!")
		return
	
	selected_difficulty = selected_difficulty.capitalize()
	print("✅ Final difficulty:", selected_difficulty)
...
func change_scene(scene_path: String):
	...
	if error != OK:
		print("⚠️ Failed to load scene:", scene_path)
...
func set_difficulty(difficulty):
	...
	print("⚙️ Setting difficulty to:", difficulty)
	selected_difficulty = difficulty
	
	if multiplayer.is_server():
		print("📡 Broadcasting difficulty to clients...")
